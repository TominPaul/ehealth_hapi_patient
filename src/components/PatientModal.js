...
const PatentModal = (props) => {
  ...
  return props.isOpen ? (
    <div>
      <div
        className="py-12 bg-gray-700/50 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0"
        id="modal"
      >
        <div
          role="alert"
        ...
        >
          <div className="relative py-6 px-6 md:px-10 bg-white shadow-md rounded border border-gray-400">
            ...
            <label
              htmlFor="name"
              className="text-gray-800 mt-6 text-sm font-bold leading-tight tracking-normal"
            >
              Patient Name
            </label>
            <input
            ...
            <div className="relative mb-5 mt-2">
              ...
              <input
                id="expiry"
                className="text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border datepicker"
